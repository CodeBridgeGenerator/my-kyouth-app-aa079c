...
import seederData from "./addtocart.seeder.json";
...
const AddtocartSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AddtocartSeederDialogComponent);
